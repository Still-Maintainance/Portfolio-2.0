...
export default function Navbar() {
  return (
    <div className="hidden rounded-full bg-gradient-to-r from-[#FFD49C] to-[#7A87FB] p-[2px] lg:block">
      <nav className="flex items-center justify-between gap-x-10 rounded-full bg-[#1C1C1C]/90 backdrop-blur-sm transition-all duration-300">
        <div className="m-1 rounded-full bg-[#1e1d1d] px-4 transition-all duration-300 hover:scale-110 cursor-pointer">
          <a href="#home">
...
export function NavButton({ className, setIsMenuOpen, isMenuOpen }) {
  return (
    <div className="group relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#FFD49C] to-[#7A87FB] p-[2px] transition-all duration-300 hover:shadow-lg hover:shadow-[#7A87FB]/50 lg:hidden">
      ...
      {isMenuOpen && (
        <div className="absolute top-full right-0 z-50 mt-2 w-48 rounded-lg border border-[#363636] bg-[#1C1C1C]/90 backdrop-blur-md shadow-lg">
          <nav className="flex flex-col">
            <Navitem href="#about" className="block px-4 py-3 transition-colors duration-200 first:rounded-t-lg hover:bg-[#292929]">
              About
            </Navitem>
            <Navitem href="#projects" className="block px-4 py-3 transition-colors duration-200 hover:bg-[#292929]">
              Projects
            </Navitem>
            <Navitem href="#contact" className="block px-4 py-3 transition-colors duration-200 last:rounded-b-lg hover:bg-[#292929]">
              Contact me
            </Navitem>
          </nav>
        </div>
