...
export default function Project({ title, number }) {
  return (
    <div className="mx-auto mt-10 flex w-9/11 flex-col items-start justify-center gap-5 bg-[#151515] pb-8 md:flex-row">
      <div className="mt-8 h-100 w-full bg-linear-to-r from-[#FFD49C] to-[#7A87FB]">
